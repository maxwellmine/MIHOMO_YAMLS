...
#### 📝 Clashmi-fx.yaml
- **路径**: `bgpeer/Clashmi-fx.yaml` | **大小**: 18.0 KB | [查看源码](https://github.com/HenryChiao/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/bgpeer/Clashmi-fx.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
<summary>🔍 策略组 (26个)</summary>
...
#### 📝 mihomo.yaml
- **路径**: `echs-top/mihomo.yaml` | **大小**: 10.2 KB | [查看源码](https://github.com/HenryChiao/MIHOMO_YAMLS/blob/main/THEYAMLS/General_Config/echs-top/mihomo.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
